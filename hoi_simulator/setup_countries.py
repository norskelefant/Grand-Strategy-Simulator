...
def create_germany(): 
    ...
    hessen = state.State("Hessen", 8, 2, 1, 0, 4, False, None)
    ...
    niederbayern = state.State("Niederbayern", 6, 0, 0, 0, 3, False, None)
    ...
    westfalen = state.State("Westfalen", 8, 1, 3, 0, 3, False, None)
    wurttemberg = state.State("Württemberg", 8, 1, 5, 0, 4, False, None)
    ...
    germany = country.Country("Germany", 
                       ...
                       None, None, 20, 15, 28, 10, construction.Construction(), 4, 0.24)
